...
func (app *application) routes() http.Handler {
	...
	mux.Get("/admin", dynamicMiddleware.Append(app.requireAuthentication).ThenFunc(app.getMainPageTeacher))
	...
	mux.Post("/admin/createsyllabus", dynamicMiddleware.Append(app.requireAuthentication).ThenFunc(app.createSyllabus))
