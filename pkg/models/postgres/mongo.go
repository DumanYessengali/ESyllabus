...
////-------------------------TABLE 1 _____START
//
//func (c *MongoModel) InsertTempSessionTopic(topic *models.TempSessionTopic, collectionName string){
...
//
//
//func (c *MongoModel) GetTempSessionTopic(syllabusInfoId int, collectionName string) []*models.TempSessionTopic{
//	cursor, err := c.Pool.Collection(collectionName).Find(context.TODO(),
//		bson.D{
//			{"syllabusinfoid", syllabusInfoId},
//		})
...
//		log.Fatal(err)
//	}
//	var tempSessionTopics []*models.TempSessionTopic
...
//
//
//func (c *MongoModel) DeleteTempSessionTopic(topic *models.TempSessionTopic, collectionName string){
//	_, err := c.Pool.Collection(collectionName).DeleteOne(context.TODO(), 		bson.D{
//		{"syllabusinfoid", topic.SyllabusInfoId},
//	})
//	fmt.Println(topic.SyllabusInfoId)
//	if err != nil {
//		log.Fatal(err)
//	}
//}
//
//func (c *MongoModel) UpdateTempSessionTopic(topic *models.TempSessionTopic, collectionName string){
...
////-------------------------TABLE 2 _____START
//
//func (c *MongoModel) InsertTempStudentTopic(topic *models.TempStudentTopic, collectionName string){
//	_, err := c.Pool.Collection(collectionName).InsertOne(context.TODO(), topic)
//	if err != nil {
//		log.Fatal(err)
//	}
...
//
//
//func (c *MongoModel) GetTempStudentTopic(syllabusInfoId int, collectionName string) []*models.TempStudentTopic{
//	cursor, err := c.Pool.Collection(collectionName).Find(context.TODO(),
//		bson.D{
//			{"syllabusinfoid", syllabusInfoId},
//		})
...
//		log.Fatal(err)
//	}
//	var tempStudentTopics []*models.TempStudentTopic
...
//}
//
//func (c *MongoModel) DeleteTempStudentTopic(topic *models.TempStudentTopic, collectionName string){
//	_, err := c.Pool.Collection(collectionName).DeleteOne(context.TODO(), 		bson.D{
//		{"syllabusinfoid", topic.SyllabusInfoId},
//	})
//	if err != nil {
...
//}
//
//func (c *MongoModel) UpdateTempStudentTopic(topic *models.TempStudentTopic, collectionName string){
